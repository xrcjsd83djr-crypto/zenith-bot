  ...
  export async function execute(interaction: ChatInputCommandInteraction) {
    ...
    try {
      if (sub === "premium-grant") {
        ...
        const res = await api.post("/admin/give-premium", { guildId, days });
